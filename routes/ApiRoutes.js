...
route.post('/fetch-shows', async function (req, res) {
    ...
    if (filterParams.area && (filterParams.area === 'גוש דן' || filterParams.name === 'גוש דן')) {
    ...
    } else if (filterParams.area && (filterParams.area === 'ירושלים והסביבה' || filterParams.name === 'ירושלים והסביבה')) {
        main_query["showLocations.city"] = {
    ...
    } else if (filterParams.area && (filterParams.area === 'דרום' || filterParams.name === 'דרום')) {
        main_query["showLocations.city"] = {
    ...
    } else if (filterParams.area && (filterParams.area === 'אילת' || filterParams.name === 'אילת')) {
        main_query["showLocations.city"] = {
            $in: [`אילת`]
        }
    } else if (filterParams.area && (filterParams.area === 'חיפה והסביבה' || filterParams.name === 'חיפה והסביבה')) {
        main_query["showLocations.city"] = {
    ...
    } else if (filterParams.area && (filterParams.area === 'צפון (צפון + חיפה)' || filterParams.name === 'צפון')) {
        main_query["showLocations.city"] = {
